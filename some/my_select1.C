void my_select1(){
  //Jpsi->eta phi eta'
  //eta->2gamma phi->2K eta'->pip pim eta
  ...
  TFile *ofile=new TFile("mmrightcomb_mceagle.root","RECREATE");
...
//  Double_t m_gam_rho;
 ...
 // const Double_t m_etap=0.9578;
  ...
  //const Double_t w_eta=1.3;
  //const Double_t w_etap=1.6;
...
//**1**
//12+34
    p_2gam1= *gamma1_unfitted+ *gamma2_unfitted;
    p_2gam2= *gamma3_unfitted+ *gamma4_unfitted;

    m_2gam1=p_2gam1.M();
    m_2gam2=p_2gam2.M();
    //veto pi0
   // if (((m_2gam1>0.103)&&(m_2gam1<0.148))||((m_2gam2>0.103)&&(m_2gam2<0.148)))continue;

    deltasq=(m_2gam1-m_eta)*(m_2gam1-m_eta)+(m_2gam2-m_eta)*(m_2gam2-m_eta);
...
//**2**
//13+24
    p_2gam1= *gamma1_unfitted+ *gamma3_unfitted;
    p_2gam2= *gamma2_unfitted+ *gamma4_unfitted;
...
//**3**
//14+23
    p_2gam1= *gamma1_unfitted+ *gamma4_unfitted;
    p_2gam2= *gamma2_unfitted+ *gamma3_unfitted;
...
//=***********************
//gamma1_f&gamma2_f : gamma from eta1;
//gamma3_f&gamma4_f : gamma from eta2;
//=***********************
    ...
    switch (mark1)
    {
      ...
      gamma2_f->SetPxPyPzE(gamma3_unfitted->Px(),gamma3_unfitted->Py(),gamma3_unfitted->Pz(),gamma3_unfitted->E());
      gamma3_f->SetPxPyPzE(gamma4_unfitted->Px(),gamma4_unfitted->Py(),gamma4_unfitted->Pz(),gamma4_unfitted->E());
      break;
