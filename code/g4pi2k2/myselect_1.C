...
//Name of the file.
  chain->Add("data_g4pi2k2_0912.root");
//Name of the right-combined file.
  TFile *ofile=new TFile("rightcomb_data_g4pi2k2_0912.root","RECREATE");
...
//1 2 + 3 4
  ...
  //  if ((m_2gam_1>low_pi0)&&(m_2gam_1<up_pi0)) continue;
   // if ((m_2gam_2>low_pi0)&&(m_2gam_2<up_pi0)) continue;
    ...
    deltasq=(m_2gam_1-m_eta)*(m_2gam_1-m_eta)/(w_eta*w_eta)+(m_2gam_2-m_eta)*(m_2gam_2-m_eta)/(w_etap*w_etap);
...
//1 3 + 2 4
  ...
  //  deltasq=(m_2gam_1-m_eta)*(m_2gam_1-m_eta)+(m_2gam_2-m_eta)*(m_2gam_2-m_eta);
   deltasq=(m_2gam_1-m_eta)*(m_2gam_1-m_eta)/(w_eta*w_eta)+(m_2gam_2-m_etap)*(m_2gam_2-m_etap)/(w_etap*w_etap);
