void mass_window_rf_DG_2(){
  ...
  RooRealVar m_pipieta_th("m_pipieta_th","m_gamma_rho [GeV]",low,up);
  ...
  //RooDataSet
  //=***********
  RooDataSet etap("etap","etap",tree,m_pipieta_th);
  ...
  RooGaussian sig1 ("sig1","sig1",m_pipieta_th,mean,sigma1);
  RooGaussian sig2 ("sig2","sig2",m_pipieta_th,mean,sigma2);
 ...
 // sig.plotOn(frame);
  ...
  //Data
  RooPlot *etap_1= etap.plotOn(frame,Binning(20));
