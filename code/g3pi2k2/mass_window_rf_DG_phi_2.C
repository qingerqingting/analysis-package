...
void mass_window_rf_DG_phi_2(){
  using namespace RooFit;
  SetLyfStyle();

  //Get a better cut on m_phi.
  ...
  //Read the root file.
  TFile *f1=new TFile ("output_for_mass_phi.root");
  ...
  RooChebychev bkg("bkg","background p.d.f.",m_2k,RooArgList(c0,c1,c2)) ;
 ...
 // Double_t FRAC=1;
  ...
  //Static box
 // phi.statOn(frame,Layout(0.2,0.55));
  ...
  leg->AddEntry(h_phi,"Data:phi","LPE");
