void test(){
  ...
  //Get the spectrum of eta and etap. using MCTruth match method.
  ...
  TH1F *h12=new TH1F ("h12","The mass spectrum of phi&etap",20,1.9,2.4);
  h12->GetXaxis()->SetTitle("m_{#phi+#eta'} [GeV]");
  setymass(h12);

  TH1F *h13=new TH1F ("h13","The mass spectrum of phi&etap",20,1.9,2.4);
