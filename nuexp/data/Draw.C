...
void Draw(){
	...
	//Set the value luminosity vs cross section 
        ...
        TGraph *C13 = new TGraph("C13_1.txt");
                C13->SetLineColor(1);
                C13->SetMarkerColor(1);
                C13->SetLineWidth(1);
                C13->Draw("AP");
                C13->GetYaxis()->SetTitle("#Delta E_{1} (MeV)");
                C13->GetXaxis()->SetTitle("#Delta E_{2} (MeV)");
                C13->GetYaxis()->SetRangeUser(-5,80);
        TGraph *C12 = new TGraph("C12_1.txt");
                C12->SetLineColor(2);
                C12->SetMarkerColor(2);
                C12->SetLineWidth(1);
                C12->Draw("Psame");

        TGraph *C11 = new TGraph("C11_1.txt");
                C11->SetLineColor(3);
                C11->SetMarkerColor(3);
                C11->SetLineWidth(1);
                C11->Draw("Psame");

        TGraph *Be11 = new TGraph("Be11_1.txt");
                Be11->SetLineColor(4);
                Be11->SetMarkerColor(4);
                Be11->SetLineWidth(1);
                Be11->Draw("Psame");
        
        TGraph *Be10 = new TGraph("Be10_1.txt");
                Be10->SetLineColor(5);
                Be10->SetMarkerColor(5);
                Be10->SetLineWidth(1);
                Be10->Draw("Psame");
        
        TGraph *Be9 = new TGraph("Be9_1.txt");
                Be9->SetLineColor(6);
        ...
        TGraph *Li9 = new TGraph("Li9_1.txt");
                Li9->SetLineColor(7);
                Li9->SetMarkerColor(7);
                Li9->SetLineWidth(1);
                Li9->Draw("Psame");
        
        TGraph *Li8 = new TGraph("Li8_1.txt");
                Li8->SetLineColor(8);
                Li8->SetMarkerColor(8);
                Li8->SetLineWidth(1);
                Li8->Draw("Psame");
        TGraph *Li7 = new TGraph("Li7_1.txt");
                Li7->SetLineColor(9);
                Li7->SetMarkerColor(9);
                Li7->SetLineWidth(1);
                Li7->Draw("Psame");

        TGraph *He6 = new TGraph("He6_1.txt");
                He6->SetLineColor(10);
                He6->SetMarkerColor(10);
                He6->SetLineWidth(1);
                He6->Draw("Psame");

        TGraph *He4 = new TGraph("He4_1.txt");
                He4->SetLineColor(11);
                He4->SetMarkerColor(11);
                He4->SetLineWidth(1);
                He4->Draw("Psame");

        TGraph *He3 = new TGraph("He3_1.txt");
                He3->SetLineColor(12);
                He3->SetMarkerColor(12);
                He3->SetLineWidth(1);
                He3->Draw("Psame");

        TGraph *H3 = new TGraph("H3_1.txt");
                H3->SetLineColor(13);
                H3->SetMarkerColor(13);
                H3->SetLineWidth(1);
                H3->Draw("Psame");

        TGraph *H2 = new TGraph("H2_1.txt");
                H2->SetLineColor(14);
                H2->SetMarkerColor(14);
                H2->SetLineWidth(1);
                H2->Draw("Psame");

        TGraph *H1 = new TGraph("H1_1.txt");
                H1->SetLineColor(15);
